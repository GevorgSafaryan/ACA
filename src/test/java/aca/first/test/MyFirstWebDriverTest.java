...
public class MyFirstWebDriverTest {
	...
	/*
	 * @AfterSuite() public void afterSuite(){ WebDriver driver = new
	 * ChromeDriver(); driver.close(); driver.quit(); }
	 */
	/*
	 ...
	 * System.setProperty("webdriver.chrome.driver",
	 * "C:\\Users\\Gevor\\Downloads\\chromedriver.exe"); WebDriver driver = new
	 * ChromeDriver(); driver.get("https:\\sport.totogaming.am");
	 * driver.manage().window().maximize();
	 * driver.findElement(By.xpath(Constants.logo));
	 * Assert.assertTrue(driver.findElement(By.xpath(Constants.logo)) != null);
	 ...
	 * Thread.sleep(2000); new Actions(driver).dragAndDrop(draggable,
	 * target).perform(); }
	 * 
	 ...
	 * null); driver.findElement(By.xpath(Constants.livetv)).click();
	 ...
	 * xpath("//button[@class = 'tl_btn_popup login_btn btnSec transBg']")).
	 * click(); Thread.sleep(2000); driver.findElement(By.
	 * xpath("//div[@class = 'tl_drop_down tl_acc_lang flex ternBtn transBg']"))
	 ...
	 * click(); driver.findElement(By.
	 * xpath("//input[@id = 'classic_bet_sum']/../../div[5]/div[1]/label")).
	 * click(); driver.findElement(By.
	 * xpath("//input[@id = 'classic_bet_sum']/../../div[6]/div[1]/label")).
	 * click();
